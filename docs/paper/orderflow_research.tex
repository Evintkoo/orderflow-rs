...
{\large\bfseries Evin Tkoovonzko}\\[0.3cm]
{\normalsize\color{gray1} Student ID: [Student ID]}

\vspace{1.0cm}

{\normalsize
Department of Finance and Quantitative Methods\\[0.2cm]
[University Name]\\[0.6cm]
}

{\normalsize
A thesis submitted in partial fulfilment of the requirements\\
for the degree of\\[0.3cm]
\textbf{Master of Science in Financial Engineering}\\[0.3cm]
(or Bachelor of Science with Honours in Quantitative Finance)
}
...
{\normalsize
\begin{tabular}{rl}
\textbf{Supervisor:} & [Supervisor Name, Title] \\[0.2cm]
\textbf{Submitted:}  & April 2025 \\
\end{tabular}
}
...
I hereby declare that this thesis is my own original work and has not
...
the author during the period of study.
...
The author wishes to thank the supervisor, [Supervisor Name], for
guidance and feedback throughout the course of this project.
Thanks are also due to the open-source communities behind the Rust
